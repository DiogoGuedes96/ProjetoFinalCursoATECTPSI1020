...
return [
  ...
  'redirectUri'       => env('OAUTH_REDIRECT_URI', 'https://tpsi.kissweb.pt/calback365'),
  'scopes'            => env('OAUTH_SCOPES', ''),
  'authority'         => env('OAUTH_AUTHORITY', 'https://login.microsoftonline.com/62ae67b5-44e8-4f59-bc21-53be9eca6f7a'),
