...
class CoordinatorController extends Controller
{
    ...
    public function all()
    {
        $turmas=auth()->user()->coordinator_classes;
        return view('coordinator.dashboard',['classes'=>$turmas]);
    }
    ...
    public function update(Request $request){
        ...
        if ($request->user_password !=  $request->confirmPassword) {
            return redirect()->route('coordinatorProfile')->with('error','Passwords têm que ser iguais');
        }
        ...
        return redirect()->route('coordinatorProfile')->with('sucesso','Perfil editado com sucesso');
    }
