...
class StudentController extends Controller
{
    ...
    public function update(Request $request){
        ...
        if ($request->user_password !=  $request->confirmPassword) {
            return redirect()->route('studentProfile')->with('error','Passwords têm que ser iguais');
        }
        ...
        return redirect()->route('studentProfile')->with('sucesso','Perfil editado com sucesso');
    }
}
