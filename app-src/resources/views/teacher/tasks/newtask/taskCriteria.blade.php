...
<div class="container-fluid">
    <form method="POST" action="{{ route('teacherNewTaskCriteriaSave',$task->task_id) }}">
        @csrf
        <div class="col-sm-12 py-3">
            <div class="default-according" id="accordion">
                                ...
                                <div class="row">
                                    <div class="col-7">
                                        <div class="checkbox checkbox-primary" style="margin-top: -10px">
                                            <input id="checkbox_gerais_{{$id}}"
                                                value="{{ $criteria->admin_criteria_id }}" type="checkbox"
                                                name="criterios_gerais[]">
                                            <label for="checkbox_gerais_{{$id}}"
                                                onclick="criteriaActivate({{ $id }}, 'gerais')"
                        ...
                        <div class="row">
                            ...
                            <div class="col-2 text-end">
                                <div class="row">
                                    <div class="col-7">
                                        <div class="checkbox checkbox-primary" style="margin-top: -10px">
                                            <input id="checkbox_curso_{{$id}}"
                                                value="{{ $criteria->admin_criteria_id }}" type="checkbox"
                                                name="criterios_curso[]">
                                            <label for="checkbox_curso_{{$id}}"
                                                onclick="criteriaActivate({{ $id }}, 'curso')"
                                                style="padding-left: 0"></label>
                                        </div>
                                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-2 text-end">
                                <div class="row">
                                    <div class="col-7">
                                        <div class="checkbox checkbox-primary" style="margin-top: -10px">
                                            <input id="checkbox_turma_{{$id}}"
                                                value="{{ $criteria->coordinator_criteria_id }}" type="checkbox"
                                                name="criterios_turma[]">
                                            <label for="checkbox_turma_{{$id}}"
                                                onclick="criteriaActivate({{ $id }}, 'turma')"
                                                style="padding-left: 0"></label>
                                        </div>
                                    </div>
                ...
                <div class="row">
                    <div class="my-3 d-flex">
                        ...
                        <div class="col-7 col-sm-9">
                            <button onclick="window.location.replace('{{ route('teacherCriteriaNew') }}')" type="button" class="btn btn-new btn-new-tarefa">
                                <i data-feather="plus"></i>
                            </button>
                            <button onclick="window.location.replace('{{ route('teacherCriteriaNew') }}')" type="button" class="btn btn-new btn-new-tarefa-mobile">
                                <i data-feather="plus"></i>
                            </button>
                        </div>
                        <div class="col-2 col-sm-1">
                ...
                @foreach ($criterios_teacher as $criteria)
                <div class="card">
                    <div class="card-header card-header-tarefa collapsed" id="{{$id}}headingOne"
                        data-bs-toggle="collapse" data-bs-target="#collapseOne{{ $id}}" aria-expanded="false"
                        aria-controls="collapseOne">
                        <div class="row">
                            <div class="col-10">
                                <h6>{{ $criteria->teacher_criteria_name }}</h6>
                            </div>
                            <div class="col-2 text-end">
                                <div class="row">
                                    <div class="col-7">
                                        <div class="checkbox checkbox-primary" style="margin-top: -10px">
                                            <input id="checkbox_teacher_{{$id}}"
                                                value="{{ $criteria->teacher_criteria_id }}" type="checkbox"
                                                name="criterios_teacher[]">
                                            <label for="checkbox_teacher_{{$id}}"
                                                onclick="criteriaActivate({{ $id }}, 'teacher')"
                                                style="padding-left: 0"></label>
                                        </div>
                                    </div>
                                    <div class="col-5" id="div_weight_teacher_{{$id}}">
    ...
    function criteriaActivate(id, type) {
        switch (type) {
            ...
            case 'turma':
                ...
                break;
            case 'teacher':
                if (document.getElementById("checkbox_teacher_" + id).checked) {
                    document.getElementById("div_weight_teacher_" + id).innerHTML = '';
                } else {
                    document.getElementById("div_weight_teacher_" + id).innerHTML = '<input class="form-control" name="weight_teacher[]" type="text" style="margin-top: -5px">';
                }
                break;
            default:
                break;
