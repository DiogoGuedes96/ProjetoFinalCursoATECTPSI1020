  ...
  <div class="page-wrapper compact-wrapper" id="pageWrapper">
    ...
    <div class="page-main-header">
      <div class="main-header-right row m-0">
        <div class="main-header-left">
          <div class="logo-wrapper"><a href="{{ route('studentsDashboard') }}"><img class="img-fluid"
    ...
    <div class="page-body-wrapper sidebar-icon">
      ...
      <header class="main-nav">
        <div class="sidebar-user text-center"><a class="setting-primary" href="{{ route('studentProfile') }}"><i
          ...
          <ul>
            <li>
              <span>
                @for($i = 1;$i<=5;$i++) @if($i <=auth()->user()->user_rating)
              ...
              <p>Rating {{auth()->user()->user_rating}}</p>
            </li>
          </ul>
        </div>
        <nav>
          <div class="main-navbar">
            ...
            <div id="mainnav">
              <ul class="nav-menu custom-scrollbar">
                ...
                <li><a class="nav-link menu-title" href="{{route('studentsDashboard')}}"><i
                      data-feather="home"></i><span>Dashboard</span></a>
                  <ul class="nav-submenu menu-content">
                  </ul>
                </li>
                <li><a class="nav-link menu-title" href="{{route('studentsEvaluations')}}"><i
                  data-feather="users"></i><span>Avaliações</span></a>
                  <ul class="nav-submenu menu-content">
                  </ul>
                </li>
