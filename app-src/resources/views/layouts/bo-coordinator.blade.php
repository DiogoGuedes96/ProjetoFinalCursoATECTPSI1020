...
<body>
  ...
  <div class="page-wrapper compact-wrapper" id="pageWrapper">
    ...
    <div class="page-main-header">
      <div class="main-header-right row m-0">
        <div class="main-header-left">
          <div class="logo-wrapper"><a href="{{ route('coordinatorDashboard') }}"><img class="img-fluid"
    ...
    <div class="page-body-wrapper sidebar-icon">
      ...
      <header class="main-nav">
        <div class="sidebar-user text-center"><a class="setting-primary" href="{{ route('coordinatorProfile') }}"><i
          ...
          <div class="main-navbar">
            ...
            <div id="mainnav">
              <ul class="nav-menu custom-scrollbar">
                ...
                <li><a class="nav-link menu-title" href="{{route('coordinatorTasks')}}"><i
                      data-feather="home"></i><span>Tarefas</span></a>
                  <ul class="nav-submenu menu-content">
                  </ul>
                </li>
                <li><a class="nav-link menu-title link-nav" href="{{route('coordinatorLibrary')}}"><i
                  data-feather="archive"></i><span>Biblioteca</span></a>
                  <ul class="nav-submenu menu-content">
                  </ul>
                </li>
                <li><a class="nav-link menu-title link-nav" href="{{route('coordinatorDashboard')}}"><i
                      data-feather="layout"></i><span>Coordenação</span></a>
                  <ul class="nav-submenu menu-content">
                  </ul>
                </li>
  ...
  <script>
    ...
    function btn_save(){
        document.getElementById("task_form").action = "{{ route('coordinatorNewTaskSave', 'no') }}";
        document.getElementById("task_form").submit();
    }
    function btn_continue() {
        document.getElementById("task_form").action = "{{ route('coordinatorNewTaskSave', 'yes') }}";
        document.getElementById("task_form").submit();
    }
  </script>
