...
<div class="container-fluid">
    ...
    @endif
    <div class="row">
        <form action="{{ route('adminGeneralCriteriaUpdate', $admin_criteria_general->admin_criteria_id) }}" method="post">
            @csrf
            <div class="row py-3">
                <div class="col-sm-10">
                    <label class="form-label input" for="criteria_title">Titulo do critério</label>
                    <input class="form-control" type="text" id="criteria_title" name="admin_criteria_name" placeholder="Dê um título ao critério..." value="{{ $admin_criteria_general->admin_criteria_name }}">
                </div>
                <div class="col-sm-2 pt-sm-0 pt-3">
                    ...
                    <select class='form-select form-control' id='criteria_type' name='admin_criteria_scale_type'>
                        @foreach ($criteriaScaleNames as $criteriaScaleName)
                            @if ($criteriaScaleName->scale_id == $admin_criteria_general->admin_criteria_scale_type)
            ...
            <div class="col-sm-12 pb-3">
                ...
                <input class="form-control" type="text" id="criteria_text" name="admin_criteria_text" placeholder="Escreva o criterio completo..." value="{{ $admin_criteria_general->admin_criteria_text }}">
            </div>
