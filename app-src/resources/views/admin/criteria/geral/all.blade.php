                ...
                <div class="col-6 p-0">
                    <div class="bookmark">
                        <ul>
                            ...
                            <a href="{{ route('adminGeneralCriteriaNew') }}"><button
                                ...
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu dropdown-edit" aria-labelledby="dropdownMenuButton">
                                        <li><a class="dropdown-item"
                                                href="{{ route('adminGeneralCriteriaEdit', $criteria->admin_criteria_id) }}">Editar</a></li>
                                        <div class="dropdown-divider"></div>
                                        <li><a class="dropdown-item"
                                                href="{{ route('adminGeneralCriteriaDelete', $criteria->admin_criteria_id) }}">Apagar</a>
                                        </li>
                                    </ul>
                                </div>
                            </td>
