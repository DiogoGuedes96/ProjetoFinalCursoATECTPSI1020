...
<div class="container-fluid">
    ...
    @endif
    <div class="row">
        <form action="{{ route('adminGeneralCriteriaSave') }}" method="post">
            @csrf
            <div class="row py-3">
                <div class="col-sm-10">
            ...
            <div class="col-sm-12 pb-3">
                ...
                <input class="form-control" type="text" id="criteria_text" name="admin_criteria_text" placeholder="Escreva o criterio completo...">
            </div>
